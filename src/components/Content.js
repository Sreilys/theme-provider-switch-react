    ...
    <ContentContainer>
      {loading ? (
        ...
        <>
          ...
          <p>The UI can switch between Dark and Light Theme thanks to styled components theme provider. Take a look at the code <a href="https://github.com/Sreilys/theme-provider-switch-react">here</a>.</p>
